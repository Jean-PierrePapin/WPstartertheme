...
function testimonials_init() {
    $labels = array(
        ...
        'singular_name'         => _x( 'testimonialss', 'Post type singular name', 'testimonials' ),
        'menu_name'             => _x( 'testimonialss', 'Admin Menu text', 'testimonials' ),
        'name_admin_bar'        => _x( 'testimonialss', 'Add New on Toolbar', 'testimonials' ),
        ...
        'archives'              => _x( 'testimonialss archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'testimonials' ),
        ...
        'items_list_navigation' => _x( 'testimonialss list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'testimonials' ),
        'items_list'            => _x( 'testimonialss list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'testimonials' ),
    );
